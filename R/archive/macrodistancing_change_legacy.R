...
# save fitted model
saveRDS(fitted_model, "outputs/fitted_macro_model_legacy.RDS")
...
saveRDS(pred_trend,
        file = "outputs/macrodistancing_trends_legacy.RDS")
...
saveRDS(pred_summary,
        file = "outputs/macrodistancing_trend_summary_legacy.RDS")
...
saveRDS(survey_points, "outputs/macro_data_fit_legacy.RDS")
...
save_ggplot("macrodistancing_effect_legacy.png",
            width = 11.69 / 1.5,
            height = 8.27 / 2.5)
...
save_ggplot("macrodistancing_effect_no_data_vis_legacy.png",
            width = 11.69 / 1.5,
            height = 8.27 / 2.5)
...
save_ggplot("macrodistancing_effect_six_month_legacy.png")
